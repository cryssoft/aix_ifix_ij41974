...
#    7.2.5.2    IJ43598s2b.221027.epkg.Z  key_w_fix  TCPIP
#    7.2.5.3    IJ41974s3a.221025.epkg.Z  key_w_fix  TCPIP <<-- covered here
#    7.2.5.3    IJ41974s3b.221213.epkg.Z  key_w_fix  TCPIP
#    7.2.5.4    IJ41974s4a.221017.epkg.Z  key_w_fix  TCPIP <<-- covered here
...
#    3.1.3.14    IJ41974s3a.221025.epkg.Z  key_w_fix  TCPIP <<-- covered here
#    3.1.3.21    IJ41974s4a.221017.epkg.Z  key_w_fix  TCPIP
#
#-------------------------------------------------------------------------------
#
class aix_ifix_ij41974 {
    ...
    if ($::facts['osfamily'] == 'AIX') {
        ...
        if (($ifixSuffix != 'unknown') and ($ifixBuildDate != 'unknown')) {
            ...
            unless ($ifixFullName in $::facts['aix_ifix']['hash'].keys) {
                ...
                $ifixStagingSource = "puppet:///modules/aix_ifix_ij41974/${ifixName}${ifixSuffix}.${ifixBuildDate}.epkg.Z"
